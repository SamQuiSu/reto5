 ...
 * @author ssqui
 */
public class vistaConsulta2 extends javax.swing.JFrame {
...
public void mostarDatos() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaConsulta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaConsulta2().setVisible(true);
            }
        });
    }
